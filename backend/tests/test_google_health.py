...
def test_steps_mapping_uses_sumSteps():
    pts = [{"startTime": "2026-06-20T00:00:00Z", "value": {"sumSteps": 8500}}]
...
def test_single_value_metrics_use_first_number_fallback():
    pts = [{"date": "2026-06-20", "rollupValue": {"restingHeartRateBpm": 58}}]
...
def test_active_zone_sums_the_three_zones():
    pts = [{"startTime": "2026-06-20T00:00:00Z", "value": {
...
def test_empty_and_valueless_points_are_skipped():
    ...
    assert mapping.to_samples("hrv", [{"startTime": "2026-06-20T00:00:00Z", "value": {}}]) == []
